...
This module defines the database schema for the application using SQLAlchemy 2.0 ORM.
All DateTime columns use timezone-aware types to ensure proper handling of timestamps.

Metadata Management:
- Primary keys and foreign keys are explicitly defined in each model
