...
def find_airflow_cli_py():
    """Find the airflow cli.py file in the virtual environment."""
    ...
    cli_path = os.path.join(airflow_dir, 'cli', 'cli_parser.py')

    print(f"Looking for Airflow cli_parser.py at {cli_path}")

    if not os.path.exists(cli_path):
        print(f"Error: Could not find Airflow cli_parser.py at {cli_path}")
        return None
